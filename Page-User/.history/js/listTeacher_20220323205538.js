...
function highlightText() {
    const title = document.querySelectorAll('.content h3');
    title.forEach((title, index) => {
        ...
        titleText = titleText.substring(0, indexOf) + "<h3>" + titleText.substring(indexOf, indexOf + searchTextLength) + "</h3>" + titleText.substring(indexOf + searchTextLength, titleText.length);
