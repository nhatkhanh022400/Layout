...
function renderListPage() {
    ...
    document.getElementById('number-list').innerHTML = html;
}


function changePage() {
    const currentPages = document.querySelectorAll('.number-list li');
...
btnNext.addEventListener('click', () => {
    ...
    $('.btn-prev').removeClass('btn-active');
    $('.number-list li').removeClass('active');
    $(`.number-list li:eq(${currentPage - 1})`).addClass('active');
    getCurrentPage(currentPage);
    renderBasic();
})
