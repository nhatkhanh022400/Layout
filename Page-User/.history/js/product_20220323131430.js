...
const courseAdvanced = [
    { ids: 1, images: "images/teacher-5.png", titles: "Tên Khóa Học", teachs: "Người Dạy", dayStarts: "Bắt Đầu: 22/03/2022", statusCourses: "Trạng Thái: Hoàn Thành" },
    { ids: 2, images: "images/teacher-5.png", titles: "Tên Khóa Học", teachs: "Người Dạy", dayStarts: "Bắt Đầu: 22/03/2022", statusCourses: "Trạng Thái: Hoàn Thành" },
    { ids: 3, images: "images/teacher-5.png", titles: "Tên Khóa Học", teachs: "Người Dạy", dayStarts: "Bắt Đầu: 22/03/2022", statusCourses: "Trạng Thái: Hoàn Thành" },
    { ids: 4, images: "images/teacher-5.png", titles: "Tên Khóa Học", teachs: "Người Dạy", dayStarts: "Bắt Đầu: 22/03/2022", statusCourses: "Trạng Thái: Hoàn Thành" },
    { ids: 5, images: "images/teacher-5.png", titles: "Tên Khóa Học", teachs: "Người Dạy", dayStarts: "Bắt Đầu: 22/03/2022", statusCourses: "Trạng Thái: Hoàn Thành" },
    { ids: 6, images: "images/teacher-5.png", titles: "Tên Khóa Học", teachs: "Người Dạy", dayStarts: "Bắt Đầu: 22/03/2022", statusCourses: "Trạng Thái: Hoàn Thành" },
    { ids: 7, images: "images/teacher-5.png", titles: "Tên Khóa Học", teachs: "Người Dạy", dayStarts: "Bắt Đầu: 22/03/2022", statusCourses: "Trạng Thái: Hoàn Thành" },
    { ids: 8, images: "images/teacher-5.png", titles: "Tên Khóa Học", teachs: "Người Dạy", dayStarts: "Bắt Đầu: 22/03/2022", statusCourses: "Trạng Thái: Hoàn Thành" },
]


function renderAdvanced() {
    htmls = '';
    const contents = courseAdvanced.map((items, indexs) => {
        if (index >= start && index < end) {
            htmls+= '<div class="box">';
            htmls += '<div class="image">';
            htmls += '<img src="' + items.images + '" alt="">';
            htmls += '<div class="share">';
            htmls += '<a href="#">';
            htmls += '<button>Chi Tiết</button>';
            htmls += '</a>';
            htmls += '<div class="status"> ';
            htmls += '' + items.statusCourses + '';
            htmls += '<br>';
            htmls += '' + items.dayStarts + '';
            htmls += '<br>';
            htmls += '' + items.titles + '';
            htmls += '<br>';
            htmls += '' + items.teachs + '';
